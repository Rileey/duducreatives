        ...
        <NavBar />
            <div className="works-container">
                ...
                <div className="player-cont">
                    <iframe title="vimeo-player" src="https://player.vimeo.com/video/728787993?h=c10e97471c" width="640" height="360" className='vimeo' frameborder="0" allowfullscreen></iframe>
                    <div className="write">
                ...
                <div className="player-cont">
                        ...
                        <iframe title="vimeo-player" src="https://player.vimeo.com/video/728788905?h=89b83a6825" width="640" height="360" className='vimeo'
                ...
                <div className="player-cont">
                    ...
                    <iframe title='vimeo-player' src="https://player.vimeo.com/video/797303098?h=da568e1818" width="640" height="360" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                    <div className="write">
                ...
                <div className="player-cont">
                    ...
                    <iframe title='vimeo-player' src="https://player.vimeo.com/video/738667764?h=619a8330e7" width="640" height="360" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                    <div className="write">
                ...
                <div className="player-cont">
                    ...
                    <iframe title='vimeo-player' src="https://player.vimeo.com/video/752165294?h=2f3cf26943" width="640" height="360" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                    <div className="write">
                ...
                {/* <div className="player-cont">
                    <h1 className='work-title'>Pride Shoot - Fix Youy</h1 >
                    <iframe title='vimeo-player' src="https://player.vimeo.com/video/738660250?h=3d770f7d6e" width="640" height="360" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                    <div className="write">
