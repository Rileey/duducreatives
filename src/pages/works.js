    ...
    return (
        ...
        <NavBar />
            <div className="works-container">
                ...
                <div className="player-cont">
                    <h1 className='work-title'>CBN_DFD Focal Video</h1 >
                    <div className="work-container">
                        <iframe title='vimeo-player' src="https://player.vimeo.com/video/851205859?h=86ee42e157" className='vimeo' frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                        <div className="write">
                            <p className='desc'>Discover the inspiring success stories of businesses across Nigeria with the CBN DFD loan initiative. In this heartwarming video created by Dudu Creatives, we showcase real-life stories of entrepreneurs who have benefited from the Central Bank of Nigeria's loan initiative. Hear firsthand accounts of how the CBN DFD loan has empowered these businesses to grow and achieve their goals. From expanding their operations to launching new products, the impact of the loan has been transformative. Join us as we celebrate the spirit of entrepreneurship and the positive impact of the CBN DFD loan on businesses all across the country.</p>
                        </div>
                    </div>
                </div>
                <div className="player-cont">
                ...
                <div className="player-cont">
                    <h1 className='work-title'>Maggi Easter</h1 >
                        <div className="work-container">
                            <iframe title='vimeo-player' src="https://player.vimeo.com/video/851206150?h=0d13af25a0" className='vimeo' frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                            <div className="write">
                                <p className='desc'>Experience the future of payments with Eyowo! In this exciting ad created by Dudu Creatives, we showcase the revolutionary new payment structure from Eyowo, the fintech company and sub-company of Softcom. Designed to connect deeply with the everyday worker in Africa, this new payment structure makes it easier than ever to send and receive money with just a few clicks. With its user-friendly interface and lightning-fast transactions, Eyowo puts the power of financial freedom in the palm of your hand. Join the millions of satisfied users and start enjoying the benefits of this game-changing platform today. Watch the ad now to see how Eyowo is transforming the payments landscape in Africa.</p>
                            </div>
                        </div>    
